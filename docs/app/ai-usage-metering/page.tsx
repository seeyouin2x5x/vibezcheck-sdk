    ...
    <main className="min-h-screen flex flex-col justify-between bg-slate-50 dark:bg-[#0c0d10] text-slate-900 dark:text-zinc-100 transition-colors duration-200">
      ...
      <article className="flex-1 max-w-4xl mx-auto px-4 pt-28 pb-20 w-full space-y-16">
        ...
        <nav aria-label="Breadcrumb" className="text-xs font-mono text-slate-500 dark:text-zinc-500 flex items-center gap-2">
          ...
          <span>/</span>
          <span className="text-emerald-600 dark:text-emerald-400">AI Usage Metering</span>
        </nav>
        ...
        <header className="space-y-6">
          ...
          <div className="p-5 rounded-2xl bg-white dark:bg-zinc-900/80 border border-slate-200 dark:border-zinc-800 text-sm sm:text-base text-slate-700 dark:text-zinc-200 leading-relaxed shadow-xs">
            <strong className="text-slate-950 dark:text-white">AI usage metering</strong> is the process of capturing, aggregating, and pricing the computational resources—specifically prompt, completion, cached tokens, and tool calls—consumed by AI workloads. VibezCheck meters AI usage at the application layer with zero network latency, producing immutable usage events for billing and observability.
          </div>
        </header>
        ...
        <section className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-6 rounded-2xl bg-white dark:bg-zinc-900/40 border border-slate-200 dark:border-zinc-800/80 space-y-3 shadow-xs">
              <div className="text-xs font-mono text-slate-500 dark:text-zinc-400 uppercase tracking-wider font-medium">Raw Token Metering</div>
              <div className="text-lg font-bold text-slate-900 dark:text-zinc-300">Counts tokens, misses economics</div>
            ...
            <div className="p-6 rounded-2xl bg-emerald-50/80 dark:bg-emerald-950/20 border border-emerald-200 dark:border-emerald-500/30 space-y-3 shadow-xs">
              <div className="text-xs font-mono text-emerald-700 dark:text-emerald-400 uppercase tracking-wider font-semibold">Dollar-Denominated Metering</div>
              <div className="text-lg font-bold text-slate-950 dark:text-white">Translates usage into business metrics</div>
        ...
        <section className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            <span className="text-xs font-mono text-emerald-600 dark:text-emerald-400 font-medium">Zero Proxy Overhead</span>
          </div>
...
const result = streamText({
  ...
  prompt: 'Analyze this balance sheet and identify key capital expenditures',
        ...
        <section className="space-y-4 p-7 rounded-2xl bg-white dark:bg-zinc-900/70 border border-slate-200 dark:border-zinc-800 shadow-xs">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 text-xs text-slate-700 dark:text-zinc-300 pt-2">
            <div className="space-y-2">
              <div className="font-bold text-slate-950 dark:text-white text-sm">VibezCheck (In-Process Engine)</div>
              <ul className="space-y-1.5 text-slate-600 dark:text-zinc-400 list-disc list-inside">
            ...
            <div className="space-y-2">
              <div className="font-bold text-slate-500 dark:text-zinc-400 text-sm">Traditional API Proxy Gateways</div>
              <ul className="space-y-1.5 text-slate-500 dark:text-zinc-500 list-disc list-inside">
        ...
        <div className="p-8 rounded-2xl bg-gradient-to-r from-emerald-50 to-white dark:from-emerald-950/40 dark:to-zinc-900 border border-emerald-200 dark:border-emerald-500/20 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6 shadow-xs">
          <div className="space-y-1">
            <h3 className="text-lg font-bold text-slate-950 dark:text-white">Meter your application usage today</h3>
