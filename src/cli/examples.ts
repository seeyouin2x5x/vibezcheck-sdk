...
export const AVAILABLE_EXAMPLES: ExampleMeta[] = [
  {
    ...
    type: 'project',
    description: 'Production B2B SaaS with customer wallets, <VibezReceipt />, margins & 2026 models',
    framework: 'Next.js 15 (App Router)',
    path: 'nextjs-saas-starter',
    tags: ['Next.js 15', 'React 19', 'Full SaaS'],
  },
  {
  ...
  },
  {
    ...
    type: 'script',
    description: 'Free standalone inference cost calculation and token aggregation with zero dependencies',
